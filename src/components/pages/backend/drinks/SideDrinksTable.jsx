...
import SidesDrinksModalAdd from "./SidesDrinksModalAdd";


const SidesDrinksTable = () => {
 ...
 const {
   ...
   queryKey: ["drinks", onSearch, store.isSearch, categoryId, isfilter],
              ...
              <tr>
                ...
                <td>
                  <ul className='table-action'>
                    ...
                    <li>
                      <button type='button' data-tooltip='Archive'>
                        <Archive size={14} />
                      </button>
                    </li>
                    <li>
                      <button type='button' data-tooltip='Restore'>
                        <ArchiveRestore size={14} />
                      </button>
                    </li>
                    <li>
                      <button type='button' data-tooltip='Delete'>
                        <Trash size={14} />
                      </button>
                    </li>
                  </ul>
...
export default SidesDrinksTable;
